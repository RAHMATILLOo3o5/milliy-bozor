...
/**
 * MonthticketQuery represents the model behind the search form of `backend\models\Monthticket`.
 */
class MonthticketQuery extends Monthticket
{
    /**
     * {@inheritdoc}
     */
